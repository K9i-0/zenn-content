...
### マクロを書く
作成したパッケージのlib直下のファイルを編集します。
パッケージ名.dartというファイルがあるはずです。
...
builderのdeclareInLibraryに生成したいaugment classのコードを渡します。
