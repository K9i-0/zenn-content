---
title: "CodeRabbitのgit-worktree-runnerがチームでも使いやすくなったので紹介"
emoji: "🐙"
type: "tech"
...
何が設定されてるかも分かりやすいです。
defaultsの部分は好みが分かれるので.gtrconfigには書かない、もしくは.gtrconfig.exampleのようなファイルをgit管理するのが良いかと思います。
...
1. gtrで2つworktreeを作る
2. 片方だけビルドを済ませる
3. /add-dirなどでworktreeのディレクトリをエージェントに伝える
4. 差分からビルドキャッシュなどを判断させそれもコピー対象にする
