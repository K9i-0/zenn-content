...
![claudeのコミットが減っていることで、Codexを使ってると分かる](/images/SCR-20260504-mugt.png =400x)
_claudeのコミットが減っていることで、Codexを使ってると分かる_
...
![Codex Appのモード切り替えUI](/images/SCR-20260504-nyqd.png =400x)
_Codex Appのモード切り替えUI_
